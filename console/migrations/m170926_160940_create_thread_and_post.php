...
class m170926_160940_create_thread_and_post extends Migration
{
    ...
    public function safeUp()
    {
      ...
      $this->addForeignKey('FK_thread_created_by', 'thread', 'created_by', 'user', 'id', 'CASCADE', 'CASCADE');
      ...
      $this->addForeignKey('FK_post_created_by',  'post', 'created_by', 'user',   'id', 'CASCADE', 'CASCADE');
